...
//            for (WeatherStation station : WeatherStation.stations) {
                ...
                out.append("<tr><td>" + observation.station() + "</td>" +
                        ...
                        "<td>" + station.getHistoricTemperatures().get("%d-%02d-%02d".formatted(observationEvent.date().getYear() - 1, observationEvent.date().getMonthValue(), observationEvent.date().getDayOfMonth())) + "</td>" +
